...
// API KEYS
$marchand = array(
    "apikey" => "12912847765bc0db748fdd44.40081707", // Enrer votre apikey
    "site_id" => "445160", //Entrer votre site_ID
...
try {
    if(isset($_POST['valider']))
    {
        ...
        $customer_address = $_POST['quarter']; 
        $customer_city = $_POST['town']; 
        $customer_country = $_POST['country'];
        $customer_state = $_POST['town']; 
    ...
    //notify url
    $notify_url = $commande->getCurrentUrl().'/cinetpay/payment/cancel';
    //return url
    $return_url = $commande->getCurrentUrl().'/cinetpay/payment/success';
    $channels = "ALL";
    ...
    $formData = array(
        ...
        "customer_zip_code" => $customer_postcode //Le code postal du client 
    );
