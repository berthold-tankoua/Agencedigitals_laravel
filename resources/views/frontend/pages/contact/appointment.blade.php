...
<main>
    ...
    <section class="px-10 py-3">
        <div class="box-title text-center wow fadeInUp">
            <div class="text-subtitle text-primary">Prendre rendez-vous</div>
            <h6 class="mt-4 title">Planifier un rendez-vous avec notre equipe en toute simplicité</h6>

            <hr>
            <p class="text-danger h6">Cette section est exclusivement destinée au propriétaire immobilier.</p>
        </div>
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="contact-content">
                        ...
                        <form id="contactform" class="form-contact  container">
                            <div class="row">
                                <fieldset class="col-md-6 mb-3">
                                    <label for="name">Choisir une date</label>
                                    <input type="text" class="form-control"
                                        placeholder="Selectionner la date de rendez-vous" name="date"
                                        id="datetimepicker" required>
                                </fieldset>
                                <fieldset class="col-md-6 mb-3">
                                    <label for="name">Choisir une Heure</label>
                                ...
                                <fieldset class="col-md-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Email"
                                        name="Saisir votre email" id="email" required>
                                </fieldset>
                                <fieldset class="col-md-12 mb-3">
                                    <label for="phone">Contact :</label>
                                    <input type="tel" class="form-control w-100"
                                        placeholder="saisir votre contact whatsApp" id="phone" name="phone"
                                        required>
                                </fieldset>
                            ...
                            <div class="send-wrap">
                                <button class="tf-btn primary size-1 mb-2" id="MakeApointment" type="submit">Valider
                                    les infomations</button>
                            </div><br>
                        </form>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="contact-info">
                        <h5>Nos contacts et adresses</h5><br>
                        <ul>
                            <li class="box">
                                <h6 class="title">Localisation:</h6>
                                <p class="text-variant-1">{{ $about->country }}</p>
                            </li>
                            <li class="box">
                                <h6 class="title">Infomation:</h6>
                                <p class="text-variant-1">(+237) 696796045/681576329 <br> {{ $about->email }}</p>
                            </li>
                            <li class="box">
                                <div class="title">Heure D'ouverture:</div>
                                <p class="text-variant-1">Lundi - Vendredi: 08:00 - 18:00 <br> Samedi: 10:00 - 18:00</p>

                            </li>
                            <li class="box">
                                <div class="title">Nous Suivre:</div>
                                <ul class="box-social">
                                    <li><a href="{{ $about->facebook_link }}" class="item">
                                    ...
                                    <li><a href="{{ $about->instagram_link }}" class="item">
                                    ...
                                    <li><a href="{{ $about->twitter_link }}" class="item">
    ...
    <script>
        ...
        $("#datetimepicker").on('change', function() {
            ...
            $.ajax({
                url: "{{ url('/appointment/date/ajax') }}/" + date,
                type: "GET",
                dataType: "json",
                success: function(data) {
                    $('select[name="time"]').empty();
                    $.each(data, function(key, value) {
                        $('select[name="time"]').append('<option value="' + value.time + '">' +
                            value.time + '</option>');
                    });
                }, //End Of Retrieve Data
            }); //End Of Ajax Script
        });
        $("#MakeApointment").click(function(e) {
            e.preventDefault();
            name = $("#name").val();
            email = $("#email").val();
            phone = $("#phone").val();
