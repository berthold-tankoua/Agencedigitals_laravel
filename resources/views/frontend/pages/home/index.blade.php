                ...
                <div class="row g-4 justify-content-center">
                    <div class="col-lg-6">
                        <div class="text-center">
                            ...
                            <h2 class="wow fadeInUp h3">Contactez-moi dès aujourd'hui</h2>
                            ...
                            <form name="contactForm" id="contact_form" method="post" action="#">
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="relative">
                                            <select name="services" id="services" class="form-control">
                                                <option value="Site Web">Création / Modernisation de site web</option>
                                                <option value="Agent IA">Agents IA & automatisation</option>
                                                ...
                                                <option value="Accompagnement">Accompagnement digital complet</option>
                                            </select>
                                    ...
                                    <div class="col-md-12">
                                        <div class="text-center">
                                            <div id='submit'>
                                                <input type='submit' id='send_message' value='Envoyer le message'
                                                    class="btn-main">
                                            </div>
                                        </div>
                                    </div>
