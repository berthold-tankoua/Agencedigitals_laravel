          ...
          <div class="login-card">
            <div>
              ...
              <div class="login-main"> 
                ...
                <form action="{{ route('admin.code-check') }}" method="POST" class="theme-form">
                  ...
                  <h4 style="text-align: center;">Vérification de votre Email</h4>
                  <p style="text-align: center;">Saisir le code recu par Email </p>
                  
                  <div class="form-group">
                    <label class="col-form-label">Saisir le Code </label>
                    <input class="form-control" type="number" name="code" required="Saisir votre Code"  placeholder="Saisir le Code recu par E-mail">
                    <span class="text-danger">@error('code'){{ $message }} @enderror</span>
                  </div>

                  <br>
                  <div class="form-group mb-0">
                    <button class="btn btn-primary btn-block w-100" type="submit" style="background: #fcb800 !important; border: 1px solid #fcb800 !important; ">Valider</button>
                  </div>
                </form><br>
                <a class="float-left" title="Revenir en arriere" href="{{ route('admin.login') }}">Retour à la page précédente</a>
              </div>
            </div>
          </div>
        </div>
