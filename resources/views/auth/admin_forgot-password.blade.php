...
<head>
    ...
    <title>Admin | Modification du mot passe </title>
                ...
                <div class="login-card">
                    <div>
                        ...
                        <div class="login-main">
                            ...
                            <form action="{{ route('admin.reset') }}" method="POST" class="theme-form">
                                ...
                                <p style="text-align: center;">Entrer votre code & Mot de passe</p>

                                <div class="form-group">
                                    <label class="col-form-label">Code de verification</label>
                                    <input class="form-control" type="number" name="code"
                                        required="code Obligatoire" placeholder="Saisir le code envoye par mail">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-input position-relative">
                                        <input class="form-control" id="password" type="password" name="password"
                                            required="Mot de passe Obligatoire" placeholder="nouveau mot de passe">
                            ...
                            <a class="float-left" title="Revenir en arriere" href="{{ route('admin.login') }}">Retour à
