...
@section('content')
@section('title')
    AgenceDigitals | Mot de passe oublie
@endsection
<!-- signin section -->
<div class="py-5">
    <div class="container">
                ...
                <div class="theme-box-shadow rounded-5 theme-bg-white p-3">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <span class="fs-4 fw-bold">Mot de passe oublié</span>
                        </div>
                    </div>
                    <div class="col-12">
                        <form action="{{ route('user.send.code') }}" method="POST" class="needs-validation" novalidate>
                            @if (session('fail'))
